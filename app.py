...
# Set Streamlit page layout to wide for better visual spacing
st.set_page_config(layout="wide")

# Function to center-align headers and titles
...
# Sidebar UI: Logo and file uploader
...
# If a file is uploaded, begin processing
if uploaded_file is not None:
    bytes_data = uploaded_file.getvalue()
    data = bytes_data.decode("utf-8")
    df = preprocessor.preprocess(data)

    # Generate list of unique users (excluding group notifications)
    ...
    if st.sidebar.button("Analyse"):
        ...
        # Display top statistics in 4 columns
        ...
        # Activity map showing most active days and months
        ...
        # Weekly heatmap showing activity per weekday and hour
        ...
        # Show top busy users (only for 'Overall' option)
        ...
        # Most commonly used emojis and their proportion in a pie chart
